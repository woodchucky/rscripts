...
(function() {
    ...
    $("header .site-search input[type=text]").on("blur", function(e) {
        ...
        if (!$relatedTarget.parents("form").is($(e.target).parents("form"))) {
...
// close most popular dropdown on click
$("#most-popular-dropdown").on("click", function(e){
    $(".most-popular-menu").removeClass("active");
    $("#most-popular-dropdown").removeClass("active");
});
