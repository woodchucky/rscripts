/* ******************************************************
// Last Updated 6/29/15 by EB
// Previous Update 4/28/15 by JS
 ****************************************************** */
...
function showResults(data) {
    ...
    if (data.types.length >= 1) {
        ...
        for (i = 0; i < data.types[0].references.length; i++) {
            ...
            if (data.types[0].references[i].type == "10417") {
                if (combolimit == 20) {
                    continue;
                }
                if (data.types[0].references[i].contentid != "0") {
                    var resultline = document.createElement("li");
                    resultline.innerHTML = "<a class=\"il_drug_result\" href=\"http://reference.medscape.com/" + qrldrugpath + "/" + data.types[0].references[i].uri + "\" onclick=\"wmdTrack('il-drug');\">" + data.types[0].references[i].text + "</a>";
                ...
                resultline.innerHTML = "<a class=\"il_cond_result\" href=\"http://emedicine.medscape.com/" + qrlpath + "/" + data.types[0].references[i].uri + "\" onclick=\"wmdTrack('il-cond');\">" + data.types[0].references[i].text + "</a>";
                document.getElementById("combolist").appendChild(resultline);
                combolimit = combolimit + 1;
                $('#il_combo_nor').hide();
                ...
                resultline.innerHTML = "<a class=\"il_pro_result\" href=\"http://emedicine.medscape.com/" + qrlpath + "/" + data.types[0].references[i].uri + "\" onclick=\"wmdTrack('il-pro');\">" + data.types[0].references[i].text + "</a>";
                document.getElementById("combolist").appendChild(resultline);
                combolimit = combolimit + 1;
                $('#il_combo_nor').hide();
                ...
                resultline.innerHTML = "<a class=\"il_anat_result\" href=\"http://emedicine.medscape.com/" + qrlpath + "/" + data.types[0].references[i].uri + "\" onclick=\"wmdTrack('il-anat');\">" + data.types[0].references[i].text + "</a>";
                document.getElementById("combolist").appendChild(resultline);
                combolimit = combolimit + 1;
                $('#il_combo_nor').hide();
                ...
                resultline.innerHTML = "<a class=\"il_labm_result\" href=\"http://emedicine.medscape.com/" + qrlpath + "/" + data.types[0].references[i].uri + "\" onclick=\"wmdTrack('il-labm');\">" + data.types[0].references[i].text + "</a>";
                document.getElementById("combolist").appendChild(resultline);
                combolimit = combolimit + 1;
                $('#il_combo_nor').hide();
                ...
                resultline.innerHTML = "<a class=\"il_medd_result\" href=\"http://emedicine.medscape.com/" + qrlpath + "/" + data.types[0].references[i].uri + "\" onclick=\"wmdTrack('il-medd');\">" + data.types[0].references[i].text + "</a>";
                document.getElementById("combolist").appendChild(resultline);
                combolimit = combolimit + 1;
                $('#il_combo_nor').hide();
                ...
                resultline.innerHTML = "<a class=\"il_calc_result\" href=\"http://reference.medscape.com/calculator/" + data.types[0].references[i].uri + "\" onclick=\"wmdTrack('il-calc');\">" + data.types[0].references[i].text + "</a>";
                document.getElementById("combolist").appendChild(resultline);
                combolimit = combolimit + 1;
                $('#il_combo_nor').hide();
            }
        ...
        if (window.location.hostname.indexOf('.org') === -1) {
            ...
            $.ajax({
                ...
                if (data.length != 0) {
                    ...
                    if (data[0].activityId != "") {
                        cpEventTrack = '<script type="text/javascript">cpHlPush({"tcid": "' + data[0].tcid + '", "activityId": "' + data[0].activityId + '"});</script>';
                    } else {
                        cpEventTrack = '';
                    }
                    ...
                    $('#middle .bucketL ul li:eq(0)').after('<li style="padding-top:0"></li><li class="brandAlert"><div style="display:none;"><iframe src="http://' + vpDom + '/public/vptrack.wxml?desturl=http://' + data[0].dom + bavpurl + '/desktop_hp_left"  height="1" width="1" scrolling="no"></iframe>' + cpEventTrack + '</div><a href="http://' + data[0].dom + data[0].uri + queryamp +'src=desktop_hp_left"><div class="spacer">&nbsp;</div><div class="ifithumb"><img src="' + data[0].thumb + '" border="0" alt="" \/></div><div class="ifititle">' + fHeadti + '<span class="ifibyline">' + fPubLine + '</span><span class="ifibjc">'+data[0].jc+'</span></div><div class="spacer">&nbsp;</div></a></li>');
                    if (data.length == 2) {
                        var cpEventTrack;
                        if (data[1].activityId != "") {
                            cpEventTrack = '<script type="text/javascript">cpHlPush({"tcid": "' + data[1].tcid + '", "activityId": "' + data[1].activityId + '"});</script>';
                        } else {
                            cpEventTrack = '';
                        }
            ...
            $.ajax({
                ...
                if (data.length != 0) {
                    ...
                    $('.businessmedicine #right #specialtyNews').after('<div class="brandAlert"><div style="display:none;"><iframe src="http://' + vpDom + '/public/vptrack.wxml?desturl=http://' + data[0].dom + bavpurl + '/desktop_hp_right"  height="1" width="1" scrolling="no"></iframe>' + cpEventTrack + '</div><a href="http://' + data[0].dom + data[0].uri + queryamp+'src=desktop_hp_right"><div class="spacer">&nbsp;</div><div class="ifithumb"><img src="' + data[0].thumb + '" border="0" alt="" \/></div><div class="ifititle">' + fHeadti + '<span class="ifibyline">' + fPubLine + '</span><span class="ifibjc">'+data[0].jc+'</span></div><div class="spacer">&nbsp;</div></a></div>');
...
if ($('.medscape_ref').length != 0 && $('.homestar').length != 0) { // Reference homepages
        ...
        $.ajax({
            ...
            if (data.length != 0) {
                ...
                $('#featured .bucketContent ul.listLeft li:eq(1)').replaceWith('<li class="brandAlert"><div style="display:none;"><iframe src="http://' + vpDom + '/public/vptrack.wxml?desturl=http://' + data[0].dom + bavpurl + '/desktop_refhp_left"  height="1" width="1" scrolling="no"></iframe>' + cpEventTrack + '</div><a href="http://' + data[0].dom + data[0].uri + queryamp+'src=desktop_refhp_left" onclick="' + brandAlertTrack + '"><div class="spacer">&nbsp;</div><div class="ifithumb"><img src="' + data[0].thumb + '" border="0" alt="" \/></div><div class="ifititle">' + fHeadti + '<span class="ifibyline">' + fPubLine + '</span><span class="ifibjc">'+data[0].jc+'</span></div><div class="spacer">&nbsp;</div></a></li><li></li>');
            }
        });
    }
