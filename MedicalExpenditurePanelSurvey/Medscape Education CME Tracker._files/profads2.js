/* Updated 6/05/14 by JS */
/* Previous Update 4/16/2015 by JS */
...
profads.ads2 = {
    ...
    SetProfSizes: function() {
        ...
        if (pageCurrentURL.indexOf('viewarticle') !== -1 || $('meta[name=site]').attr("content") === "Conditions" || $('meta[name=site]').attr("content") === "Procedures") {
    ...
    ProfAdsIgnore: function() {
        ...
        if (typeof window.ads2_ignore !== "undefined") {
            setTimeout(function() {
                ...
                if (ignore.all) {
                    ...
                    var keyPOS = [];
                    $.each(window.ads2_ignore, function(index) {
                        keyPOS.push(index);
                    });
        ...
        if ($('meta[name=site]').attr("content") === "Conditions" || $('meta[name=site]').attr("content") === "Procedures") {
    ...
    ProfAdsDisplay: function(DevTypeObj) {
        if ($('meta[name=site]').attr("content") === "Conditions" || $('meta[name=site]').attr("content") === "Procedures") {
            ...
            if (typeof ads2_suppress !== "undefined") {} else {
                window.ads2_ignore = {};
    ...
    mobileAdPlacement: function() {
        ...
        } else if (pageCurrentURL.indexOf('viewcollection') != -1) {
            if ($('.confsection').length == 1) {
                $('.confsection ul.col1of2 li:eq(1)').after('<div id="ads-pos-1122" class="AdUnit" style="padding-bottom: 7px"></div>');
            } else {
    ...
    ResizeTextAds: function() {
        ...
        if ($('#ads-pos-420').length > 0) {
            var DFP420 = $('#ads-pos-420 iframe').attr('id');
            if (pageCurrentURL.indexOf('medline') != -1 || pageCurrentURL.indexOf('/viewarticle/') != -1) {
                $('#ads-pos-420 iframe').attr('width', '240');
                if ($('#ads-pos-420 iframe').contents().find("div#textAd1").length > 0) {
                    ...
                    $('#ads-pos-420 iframe').contents().find("div#textAd1").css('width', '217px');
                    $('#ads-pos-420').css('float', 'right');
                    $('#ads-pos-420').css('padding-left', '10px');
                    setTimeout(function() {
                        var adHeight = $('#ads-pos-420 iframe').contents().find("div#textAd1").outerHeight();
                        $('#ads-pos-420 iframe').attr('height', adHeight);
                    }, 250);
                } else if ($('#ads-pos-420 iframe').contents().find("div#sponsorad").length > 0) {
                    $('head', window.frames[DFP420].document).append('<link rel="stylesheet" href="http://img.medscapestatic.com/medcss/ads/dfp/text-ads.css" type="text/css" media="all">');
                    $('#ads-pos-420 iframe').contents().find("div#sponsorad").css('width', '214px');
                    $('#ads-pos-420').css('float', 'right');
                    $('#ads-pos-420').css('padding-left', '10px');
                    setTimeout(function() {
                        var adHeight = $('#ads-pos-420 iframe').contents().find("div#sponsorad").outerHeight();
                        $('#ads-pos-420 iframe').attr('height', adHeight);
                    }, 250);
                } else if ($('#ads-pos-420 iframe').contents().find("div#textDriverLong").length > 0) {
                    $('#ads-pos-420 iframe').attr('width', '600');
                    $('#ads-pos-420 iframe').contents().find("div#textDriverLong").css('width', '578px');
                    setTimeout(function() {
                        var adHeight = $('#ads-pos-420 iframe').contents().find("div#textDriverLong").outerHeight();
                        $('#ads-pos-420 iframe').attr('height', adHeight);
                    }, 250);
                } else if ($('#ads-pos-420 iframe').contents().find("body#ProfBlankAd").length > 0) {
                    $('#ads-pos-420').hide();
                }
            } else if ($('meta[name=site]').attr("content") === "Conditions" || $('meta[name=site]').attr("content") === "Procedures" || pageCurrentURL.indexOf('/news') != -1) {
                $('#ads-pos-420 iframe').attr('width', '300');
                if ($('#ads-pos-420 iframe').contents().find("div#textAd1").length > 0) {
                    $('head', window.frames[DFP420].document).append('<link rel="stylesheet" href="http://img.medscapestatic.com/medcss/ads/dfp/text-ads.css" type="text/css" media="all">');
                    $('#ads-pos-420 iframe').contents().find("div#textAd1").css('width', '277px');
                    $('#ads-pos-420').css('float', 'right');
                    $('#ads-pos-420').css('padding-left', '10px');
                    setTimeout(function() {
                        var adHeight = $('#ads-pos-420 iframe').contents().find("div#textAd1").outerHeight();
                    ...
                    $('head', window.frames[DFP420].document).append('<link rel="stylesheet" href="http://img.medscapestatic.com/medcss/ads/dfp/text-ads.css" type="text/css" media="all">');
                    $('#ads-pos-420 iframe').contents().find("div#sponsorad").css('width', '274px');
                    $('#ads-pos-420').css('float', 'right');
                    $('#ads-pos-420').css('padding-left', '10px');
                    setTimeout(function() {
                        var adHeight = $('#ads-pos-420 iframe').contents().find("div#sponsorad").outerHeight();
                    ...
                    $('#ads-pos-420 iframe').attr('width', '600');
                    $('#ads-pos-420 iframe').contents().find("div#textDriverLong").css('width', '456px');
                    setTimeout(function() {
                        var adHeight = $('#ads-pos-420 iframe').contents().find("div#textDriverLong").outerHeight();
                        $('#ads-pos-420 iframe').attr('height', adHeight);
                    }, 250);
        ...
        if ($('#ads-pos-520').length > 0) {
            $('#ads-pos-520 iframe').attr('width', '220');
            if ($('#ads-pos-520 iframe').contents().find("#textDriverShort").length > 0) {
                setTimeout(function() {
                    var adHeight = $('#ads-pos-520 iframe').contents().find("#textDriverShort").outerHeight();
                    $('#ads-pos-520 iframe').attr('height', adHeight);
                }, 250);
            }
        }
    },
        ...
        if (isMob) {
            setTimeout(function() {
                if ($('#ads-pos-2017').length > 0) {
                    $('#ads-pos-2017 iframe').attr('width', '100%');
                    if ($('#ads-pos-2017 iframe').contents().find("#gne_services_link").length > 0) {
                        setTimeout(function() {
                            var adHeight = $('#ads-pos-2017 iframe').contents().find("#gne_services_link").outerHeight();
                            $('#ads-pos-2017 iframe').attr('height', adHeight);
                        }, 500);
                    } else if ($('#ads-pos-2017 iframe').contents().find("#pfizercorp_services_link").length > 0) {
                        setTimeout(function() {
                            var adHeight = $('#ads-pos-2017 iframe').contents().find("#pfizercorp_services_link").outerHeight();
                            $('#ads-pos-2017 iframe').attr('height', adHeight);
                        }, 500);
                    }
                }
            ...
            setTimeout(function() {
                if ($('#ads-pos-421').length > 0) {
                    $('#ads-pos-421 iframe').attr('width', '660');
                    if ($('#ads-pos-421 iframe').contents().find("#gne_services_link").length > 0) {
                        setTimeout(function() {
                            var adHeight = $('#ads-pos-421 iframe').contents().find("#gne_services_link").outerHeight();
                            $('#ads-pos-421 iframe').attr('height', adHeight);
                        }, 250);
                    } else if ($('#ads-pos-421 iframe').contents().find("#pfizercorp_services_link").length > 0) {
                        setTimeout(function() {
                            var adHeight = $('#ads-pos-421 iframe').contents().find("#pfizercorp_services_link").outerHeight();
                            $('#ads-pos-421 iframe').attr('height', adHeight);
                        }, 250);
                    }
                }
    ...
    DetectSubD_D: function(SubD_D_Obj) {
        ...
        var ProfMfrDOM = new RegExp('www' + subDOMenv + '.medscape.fr');
        var ProfMdeDOM = new RegExp('www' + subDOMenv + '.medscapemedizin.de');
        var ProfMdePraxDOM = new RegExp('praxis' + subDOMenv + '.medscapemedizin.de');
        var ProfUGCDOM = new RegExp('boards' + subDOMenv + '.medscape.com');

        if (ProfNewsDOM.test(pageCurrentURL)) {
        ...
        } else if (ProfLoginDOM.test(pageCurrentURL)) {
    ...
    TestAdUnitL1L2: function(DevTObj, SubDDObj) {
        if (DevTObj.isDesktop || DevTObj.isTablet) {
            if (SubDDObj.ProfPromoNews) {
                ...
                webmd.ads2.adTarget = ['mfr', 'mfrwwwdesktop'];
            } else if (SubDDObj.ProfMDENews) {
                webmd.ads2.adTarget = ['mde', 'mdenewsdesktop'];
            } else if (SubDDObj.ProfMDEPraxis) {
                webmd.ads2.adTarget = ['mde', 'mdepraxisdesktop'];
            ...
            if (SubDDObj.ProfPromoNews) {
                ...
                webmd.ads2.adTarget = ['mfrmobileweb', 'mfrwwwmobileweb'];
            } else if (SubDDObj.ProfMDENews) {
                webmd.ads2.adTarget = ['mdemobileweb', 'mdenewsmobileweb'];
            } else if (SubDDObj.ProfMDEPraxis) {
                webmd.ads2.adTarget = ['mdemobileweb', 'mdepraxismobileweb'];
            } else if (SubDDObj.ProfEdu) {
    ...
    CapTargetKeys: function(TKeysObj) {
        ...
        var objStr = JSON.stringify(TKeysObj);

        while (objStr.length > 664) {
            //Values should be removed starting with the new All Specialties ('as'), All Concepts ('ac') segvar, followed by 'tar', followed by 'tc'.
            if (TKeysObj.as.length > 0 && TKeysObj.as[0] !== '0') {
                var AsArray = TKeysObj.as.split(",");
                AsArray.pop();
                if (AsArray.length == 0) {
                    TKeysObj.as = '0';
                } else {
                    TKeysObj.as = AsArray.join(",");
                }
            } else if (TKeysObj.ac.length > 0 && TKeysObj.ac[0] !== '0') {
                var AcArray = TKeysObj.ac.split(",");
                AcArray.pop();
                if (AcArray.length == 0) {
                    TKeysObj.ac = '0';
                } else {
                    TKeysObj.ac = AcArray.join(",");
                }
            } else if (TKeysObj.tar.length > 0 && TKeysObj.tar[0] !== '0') {
                var tarArray = TKeysObj.tar.split(",");
                tarArray.pop();
                if (tarArray.length == 0) {
                    TKeysObj.tar = '0';
                } else {
                    TKeysObj.tar = tarArray.join(",");
                }
            } else if (TKeysObj.tc.length > 0 && TKeysObj.tc[0] !== '0') {
                var tcArray = TKeysObj.tc.split(",");
                tcArray.pop();
                if (tcArray.length == 0) {
                    TKeysObj.tc = '0';
                } else {
                    TKeysObj.tc = tcArray.join(",");
                }
            }
            objStr = JSON.stringify(TKeysObj);
        }
